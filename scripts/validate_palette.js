 ...
 *
 * Categorical-palette validator from Anthropic's `dataviz` skill, copied in
 * unmodified so `palette_search.mjs` and `palette_ramps.mjs` stay runnable
 * without that skill installed. Not our work; not modified.
 */
/**
